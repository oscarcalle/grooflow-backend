...
function grooflow_menu_default_icon_color(string $moduloKey): string
{
    $map = [
        ...
        'Catálogo Turnos' => 'text-violet-400 group-hover/btn:text-violet-300',
...
function grooflow_menu_default_leaves(): array
{
    return [
        ...
        ['section' => 'Recursos Humanos', 'label' => 'Turnos (catálogo)', 'ruta' => '/catalogo/turnos', 'modulo_key' => 'Catálogo Turnos', 'icono' => 'fa-clock'],
